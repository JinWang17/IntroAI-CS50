...
# the user guess: red0, blue1, green2, yellow3, and get feedback that 2 of them are correct 
knowledge.add(Or(
...
# the user guess: blue0, red1, green2, yellow3, and get feedback that none of them are correct 
knowledge.add(And(
    Not(Symbol("blue0")),
    Not(Symbol("red1")),
    Not(Symbol("green2")),
